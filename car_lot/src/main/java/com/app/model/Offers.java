...
public class Offers {
	...
	public Offers(int car_id, int user_id, double offer_made, double asking_price, int years, boolean accepted, int offer_id) {
		super();
		this.car_id = car_id;
	...
	public String toString() {
		return "Offers [car_id=" + car_id + ", user_id=" + user_id + ", offer_made=" + offer_made + ", asking_price="
				+ asking_price + ", years=" + years + ", accepted=" + accepted + ", offer_id=" + offer_id + "]";
	}
